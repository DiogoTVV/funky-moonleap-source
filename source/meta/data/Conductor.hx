...
class Conductor
{
	...
	public static var songOffsetPosition:Float;
	...
	public static function calcBeat(daBpm:Float):Float
		return ((60 / daBpm) * 1000);
	
	public static function calcStep(daBpm:Float):Float
		return (calcBeat(daBpm) / 4);
}
